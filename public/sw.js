self.addEventListener('install', async e => {
    e.waitUntil(
        caches.open("static").then(cache => {
            return cache.addAll(["./index.html", "./hoteles.html", "./Aventuras.html", "./lugares.html", "./Restaurantes.html", "./Boaco.html", "./Carazo.html", "Chinandega.html", "./Chontales.html", "./Esteli.html", "./Granada.html", "./Jinotega.html", "./Leon.html", "./Madriz.html", "./managua.html", "./Masaya.html", "./Matagalpa.html", "./NuevaSegovia.html", "./Raan.html", "./Raas.html", "./RioSanJuan.html", "./Rivas.html", "./css/activades.css",
